			...
			switch (element.name)
			{
				...
				case "architecture":
					if (element.has.name)
					{
						...
						if (Architecture.exists(upperName))
						{
							ArrayTools.addUnique(architectures, (cast upperName : Architecture));
						}
						else
						{
					...
					if (element.has.exclude)
					{
						...
						var upperExclude = exclude.toUpperCase();
						
						if (Architecture.exists(upperExclude))
						{
							ArrayTools.addUnique(excludeArchitectures, (cast upperExclude : Architecture));
						}
						else
						{
